...
namespace Lofelt.NiceVibrations
{
    ...
    public class HapticSource : MonoBehaviour
    {
        ...
        [SerializeField]
        NiceHaptic.PresetType _fallbackPreset = NiceHaptic.PresetType.None;

        /// <summary>
        /// The haptic preset to be played when it's not possible to play a haptic clip
        /// </summary>
        [System.ComponentModel.DefaultValue(NiceHaptic.PresetType.None)]
        public NiceHaptic.PresetType fallbackPreset
        {
