...
namespace Lofelt.NiceVibrations
{
    ...
    public static class HapticController
    {
        ...
        static NiceHaptic.PresetType _fallbackPreset = NiceHaptic.PresetType.None;

        /// <summary>
        /// The haptic preset to be played when it's not possible to play a haptic clip
        /// </summary>
        public static NiceHaptic.PresetType fallbackPreset
        {
        ...
        public static void Play()
        {
            ...
            {
                remainingPlayDuration = NiceHaptic.GetPresetDuration(fallbackPreset);
                NiceHaptic.PlayPreset(fallbackPreset);
            }
        ...
        public static void Reset()
        {
            ...
            fallbackPreset = NiceHaptic.PresetType.None;
        }
