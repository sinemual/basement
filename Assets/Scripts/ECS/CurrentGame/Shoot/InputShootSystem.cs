...
namespace Client
{
    public class InputShootSystem : IEcsRunSystem
    {
        ...
        public void Run()
        {
            if (_data.RuntimeData.CurrentGameState == GameState.OnLevel && _data.RuntimeData.currentPlayerEquipMode == PlayerEquipType.Bow)
            {
